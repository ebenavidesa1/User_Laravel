                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="fechanacimiento" type="text" class="date form-control @error('fechanacimiento') is-invalid @enderror" name="fechanacimiento" value="{{ old('fechanacimiento') }}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                La contraseña debe contener un número, una letra mayúscula y un caracter especial
                                @error('password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
